namespace ReservaDesktopApp.HotelForms
{
    partial class CreateHotelForm
    {
		...
		private void InitializeComponent()
		{
			...
			txbPostalCode.Margin = new Padding(2, 2, 2, 2);
			...
			txbStreet.Margin = new Padding(2, 2, 2, 2);
			...
			cmbCities.Margin = new Padding(2, 2, 2, 2);
			...
			txbDescription.Margin = new Padding(2, 2, 2, 2);
			...
			txbName.Margin = new Padding(2, 2, 2, 2);

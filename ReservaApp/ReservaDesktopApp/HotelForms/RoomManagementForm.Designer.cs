namespace ReservaDesktopApp.HotelForms
{
	partial class RoomManagementForm
	{
        ...
        private void InitializeComponent()
        {
            ...
            // lvRoomDisplay
            // 
            lvRoomDisplay.Columns.AddRange(new ColumnHeader[] { name, quantity, price, chCapacity, clmBedType });
            ...
            // clmBedType
            // 
            clmBedType.Text = "BedType";
            clmBedType.Width = 120;
            // 
            // txbName
            // 
		...
		private ColumnHeader clmBedType;

namespace ReservaDesktopApp.HotelForms
{
	partial class RoomManagementForm
	{
		...
		private void InitializeComponent()
		{
			...
			lvRoomDisplay.Location = new Point(86, 203);
			...
			groupBox1.Location = new Point(116, 3);
			...
			// btnSaveEdit
			// 
			btnSaveEdit.Location = new Point(226, 171);
			...
			// btnEdit
			// 
			btnEdit.Location = new Point(522, 203);
			...
			// btnRemoveRoom
			// 
			btnRemoveRoom.Location = new Point(522, 259);
			...
			// btnClose
			// 
			btnClose.Location = new Point(551, 380);
